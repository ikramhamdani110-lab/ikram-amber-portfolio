...
function getSecretKey() {
  ...
  // Stable fallback so authentication still works when the secret is not
  // configured (e.g. a fresh deployment without env vars set).
  return 'ikram-amber-portfolio-fallback-session-secret-v1'
}
